...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, altkey }, "h", function () awful.util.spawn( terminal.." -e htop" ) end,
        {description = "htop" , group = "terminal apps" }),
    awful.key({ modkey, altkey }, "s", function () awful.util.spawn( terminal.." -e spt" ) end,
        {description = "spt" , group = "terminal apps" }),
    awful.key({ modkey, altkey }, "p", function () awful.util.spawn( terminal.." -e peaclock" ) end,
        {description = "peaclock" , group = "terminal apps" }),
    awful.key({ modkey, altkey }, "z", function () awful.util.spawn( terminal.." -e source ~/.zshrc" ) end,
    ...
    awful.key({ modkey, altkey }, "o", function () awful.util.spawn( "obs" ) end,
        {description = "obs" , group = "gui apps" }),
    awful.key({ modkey, altkey }, "m", function () awful.util.spawn( "spotify" ) end,
    ...
    awful.key({ }, "Print", function () awful.util.spawn( "scrot -u" ) end,
        {description = "scrot active window" , group = "screenshots" }),
    awful.key({altkey }, "Print", function () awful.util.spawn( "scrot" ) end,
        {description = "scrot monitor" , group = "screenshots" }),
