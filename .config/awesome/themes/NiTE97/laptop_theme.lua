...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    -- Create an imagebox widget which will contains an icon indicating which layout were using.
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 44, bg = theme.bg_normal, fg = theme.fg_normal })
